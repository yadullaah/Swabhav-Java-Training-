...
import com.training.CurrentBankAccount;
import com.training.SavingBankAccount;
...
public class BankAccountsTest {
	public static void main(String[] args) {
		...
		if (userInput == 1) {
			SavingBankAccount savingAccounts1 = new SavingBankAccount(123456, "Yadullah", 70000, 2000);
			...
			CurrentBankAccount currentAccounts1 = new CurrentBankAccount(23131, "Suraj", 45000, 15000);
			System.out.println("Your Account Details : \n" + currentAccounts1);
